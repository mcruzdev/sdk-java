...
public class GrpcClientStreamingTest {
  ...
  void grpcPerson() throws IOException {
    ...
    MethodDescriptor<Contributors.AddContributionRequest, Contributors.AddContributionResponse>
        createContributorMethod = ContributorsAPIGrpc.getCreateContributorMethod();

    MethodDescriptor<Person.GetPersonRequest, Person.GetPersonResponse> getPersonMethod =
